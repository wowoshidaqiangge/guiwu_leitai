 ...
 * @LastEditTime: 2019-10-28 15:02:50
 * @LastEditors: your name
 * @Description: In User Settings Edit
 * @FilePath: \04_guiwuCode\03-雷泰\leitai4.0\src\components\login.vue
 -->
<template>
  <div class="out">
    <div class="logo_box">
      远程运维系统
      <!-- <img src="/static/logo_login.png" alt=""> -->
    </div>
    <!--用户登录-->
    <el-form :model="ruleFormLogin" :rules="rulesLogin" ref="ruleFormLogin" v-show="loginShowFlag" label-position="left" label-width="0px" class="demo-ruleForm login-container">
      ...
      <el-form-item prop="account">
        <el-input class="login_account" type="text" @keyup.enter.native="userLandBt('ruleFormLogin')" v-model="ruleFormLogin.account" auto-complete="off" placeholder="请输入手机号或账号"></el-input>
      </el-form-item>
      <el-form-item prop="password" class="password">
        <el-input class="login_password" type="password" @keyup.enter.native="userLandBt('ruleFormLogin')" v-model="ruleFormLogin.password" placeholder="请输入密码"></el-input>
      </el-form-item>
      ...
      <el-form-item class="login_submit">
        <el-button type="primary" class="login_submit_btn" round @click.native.prevent="userLandBt('ruleFormLogin')" :loading="logining">确定</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-form :model="ruleFormPass" :rules="rulesRetrieve" ref="ruleFormPass" v-show="passShowFlag" label-position="left" label-width="0px" class="demo-ruleForm login-container">
      ...
      <el-form-item style="width:100%;">
        <el-button type="primary" round class="login_submit_btn" @click.native.prevent="getPasswordBt('ruleFormPass')" :loading="logining">确定</el-button>
      </el-form-item>
    </el-form>
  ...
  methods: {
    ...
    */
    ...
    backUserLogin: function () {
      ...
      back.userLogin(this.param).then(function (response) {
        ...
        // 跳转到全局示意模式页面
        this.$emit('transferuser', 'globalPage')
      }.bind(this))
    },
    // 用户注册
    ...
    */
    ...
    userInfoStore: function (info) {
      ...
      sessionSetStore('userIdMe', info.data.userId)
...
.out{
  ...
  width: 100%;
  height: 100%;
  background: url('/static/bg_login1.jpg') no-repeat;
...
.demo-ruleForm {
  ...
  background: url('/static/login_tk_bg1.png') no-repeat;
  background-size:100% 100%;
}
.demo-ruleForm .title{
  color: white;
...
.login_account{
  background: #E8F0FE url('/static/icon_login1.png') no-repeat 15px center;
  background-size: 20px auto;
}
.login_password{
  background: #E8F0FE url('/static/icon_login2.png') no-repeat 15px center;
  background-size: 20px auto;
}
...
<style>
.login_password .el-input__inner, .login_account .el-input__inner{
