          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="节点Mac" :label-width="formLabelWidth">
                <el-input class="form_ipsl_item" v-model="diaNodeInfoForm.nodeMac" placeholder="请输入节点Mac" :disabled="formAddOrModify===1"></el-input>
                <!-- <span style="font-size:14px">/s</span> -->
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="经度" :label-width="formLabelWidth">
                <el-input class="form_ipsl_item" v-model="diaNodeInfoForm.location.lon" :disabled="true" placeholder="经度"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="纬度" :label-width="formLabelWidth">
                <el-input class="form_ipsl_item" v-model="diaNodeInfoForm.location.lat" :disabled="true" placeholder="纬度"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
  ...
  methods: {
    ...
    */
    ...
    devNodeEdit: function () {
      ...
      if (this.diaNodeInfoForm.crc !== this.currentDeviceInfo.crc || this.diaNodeInfoForm.deadArea !== this.currentDeviceInfo.deadArea || this.diaNodeInfoForm.station !== this.currentDeviceInfo.station || this.diaNodeInfoForm.queryTime !== this.currentDeviceInfo.queryTime) {
    ...
    //   var removed = this.nodeListData.splice(index, 1)
    //   console.log(removed)
    },
    // 表单设置操作
